...
variable "instance_type" {
  description = "The VM size to use for prod."
  type        = string
}

variable "instance_count" {
  description = "Number of VMs to deploy in the prod environment."
  type        = number
}

variable "vm_admin_password" {
  description = "Admin password for the prod VMs. Injected by CI/CD."
  type        = string
  sensitive   = true
}
